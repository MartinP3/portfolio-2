...
<section class="flex flex-col justify-center items-center">
	<h2 class="font-bold text-4xl text-center mb-4">My skills</h2>
	<div>
		<div>
			<h3 class="font-bold text-2xl">Languages & Frameworks</h3>
			<div class="grid grid-cols-4 md:flex gap-3 my-4">
				<div>
					<img
						class="icon"
			...
			<h3 class="font-bold text-2xl">Tools & Libraries</h3>
			<div class="grid grid-cols-4 md:flex gap-3 my-4">
				<div>
					<img
						class="icon"
				...
				<div>
					<img
						class="icon"
						src="https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/Github-Dark.svg"
						alt="GitHub"
					/>
				...
				<div>
					<img
						class="icon"
						src="https://raw.githubusercontent.com/tandpfun/skill-icons/59059d9d1a2c092696dc66e00931cc1181a4ce1f/icons/Bootstrap.svg"
						alt="Bootstrap"
					/>
